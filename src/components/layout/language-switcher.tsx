...
function FlagAZ({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="320" cy="240" r="60" fill="white" />
      <circle cx="335" cy="240" r="50" fill="#e4002b" />
      <polygon fill="white" points="370,218 375,232 390,232 378,241 382,255 370,246 358,255 362,241 350,232 365,232" />
    </svg>
  );
}
...
export function LanguageSwitcher() {
  ...
  return (
    ...
    >
      {locale === "az" ? (
        <>
          <FlagAZ className="w-5 h-3.5 rounded-[2px] overflow-hidden shrink-0" />
          AZ
        </>
      ) : (
        <>
          <FlagEN className="w-5 h-3.5 rounded-[2px] overflow-hidden shrink-0" />
          EN
        </>
      )}
    </Button>
